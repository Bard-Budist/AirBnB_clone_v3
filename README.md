...
[**`api/__init__.py`**](https://github.com/Bard-Budist/AirBnB_clone_v3/blob/master/api/__init__.py), [**`api/v1/__init__.py`**](https://github.com/Bard-Budist/AirBnB_clone_v3/blob/master/api/v1/__init__.py), [**`api/v1/views/__init__.py`**](https://github.com/Bard-Budist/AirBnB_clone_v3/blob/master/api/v1/views/__init__.py), [**`api/v1/views/index.py`**](https://github.com/Bard-Budist/AirBnB_clone_v3/blob/master/api/v1/views/index.py), [**`api/v1/app.py`**](https://github.com/Bard-Budist/AirBnB_clone_v3/blob/master/api/v1/app.py)|**4. Status of your API**|It’s time to start your API! Your first endpoint (route) will be to return the status of your API
